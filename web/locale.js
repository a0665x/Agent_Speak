...
(function exposeLocale(globalScope) {
  ...
  const messages = {
    en: {
      ...
      "hero.title": "Let your Agent listen freely,",
      "hero.titleAccent": "and join the conversation.",
      "hero.lede": "Give any Agent a local voice layer that can listen, understand pauses, and naturally join the conversation.",
      ...
      "card.ttsClone.description": "VoxCPM2 voice clone and expressive TTS",
    ...
    "zh-TW": {
      ...
      "hero.title": "讓你的 Agent 自由聆聽，",
      "hero.titleAccent": "自然接話。",
      "hero.lede": "為任何 Agent 加上本機語音能力，能聆聽、理解停頓，並自然加入對話。",
      ...
      "card.ttsClone.description": "VoxCPM2 語音克隆與表情化 TTS",
      "status.title": "系統狀態",
    ...
    ja: {
      ...
      "hero.title": "Agent が自由に聴き、",
      "hero.titleAccent": "自然に会話へ。",
      "hero.lede": "あらゆる Agent に、音声を聴き、間を理解し、自然に会話へ加われるローカル音声レイヤーを提供します。",
      ...
      "card.ttsClone.description": "VoxCPM2 音声クローンと表情豊かな TTS",
      "status.title": "システム状態",
    ...
    ko: {
      ...
      "hero.title": "Agent가 자유롭게 듣고,",
      "hero.titleAccent": "자연스럽게 대화하도록.",
      "hero.lede": "어떤 Agent든 음성을 듣고, 멈춤을 이해하며, 자연스럽게 대화에 참여할 수 있는 로컬 음성 레이어를 제공합니다.",
      ...
      "card.ttsClone.description": "VoxCPM2 음성 클론 및 표현력 있는 TTS",
      "status.title": "시스템 상태",
