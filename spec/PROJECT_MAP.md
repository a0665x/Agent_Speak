...
- [AI Avatar Motion Lab design](references/20260724-ai-avatar-motion-lab-design.md)
- [AI Avatar Motion Lab implementation plan](references/20260724-ai-avatar-motion-lab-plan.md)
- [AI Avatar asset-pipeline lessons](references/lesson-20260724-ai-avatar-asset-pipeline.md)
- [ComfyUI FLF2V AI Avatar motion design](references/20260724-comfyui-avatar-motion-design.md)

## Change guide
Docker lifecycle, structured diagnostics, and image: `../run.sh`, `../Dockerfile`, `../compose.yaml`, RUNTIME.md, and references/20260722-realtime-model-reliability-and-logging-design.md. Extensible workload residency, reset/reconciliation controls, low-VRAM exclusivity, high-VRAM concurrency/multi-GPU placement, and future full-pipeline boundaries: references/20260723-resource-orchestrator-design.md; for live failures, slow warm-up, stale images, supervisor startup, and 32 GB planning, read references/lesson-20260723-resource-orchestrator-troubleshooting.md first. VoxCPM2 and zero-shot clone privacy: references/20260723-voxcpm2-tts-clone-test-design.md and its implementation plan. AI Avatar sheet verification, shared transition frame, loop-boundary scheduling, current FILM/RIFE post-processing, and `/ai_avatar`: references/20260724-ai-avatar-motion-lab-design.md, references/lesson-20260724-ai-avatar-asset-pipeline.md, and `../AI_Avatar`. Future generative AI Avatar motion is ComfyUI FLF2V-only; read references/20260724-comfyui-avatar-motion-design.md before changing asset generation. Pipeline/provider: ARCHITECTURE.md and API.md. Realtime speech-language routing: references/lesson-20260721-session-language-routing.md. Multi-model realtime ASR and generic audio devices: references/20260722-multi-model-realtime-design.md. Model selector/detail/lifecycle consistency: references/20260722-model-status-synchronization-design.md. Shared homepage/ASR particle behavior: references/20260722-interactive-particle-hero-design.md and references/20260722-particle-energy-trail-design.md. External Agent integration: SKILL_AND_MCP.md and `../skills/agent-speak/SKILL.md`. MCP implementation: `../src/agent_speak/mcp_server.py`; entry point: `../scripts/run_mcp.sh`; hardware-free regression: `../tests/test_mcp_server.py`. Project homepage, ASR, TTS clone, and AI Avatar UI: UI.md, `../web`, `../frontend/realtime`, and `../AI_Avatar`. Verification: TESTING.md. Model replacement: references/MODEL_STRATEGY.md.
